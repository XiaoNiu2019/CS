...
public class ServerSnakeNode extends Rectangle {
	
	private static final double SIZE = Game.ELEMENT_SIZE; 

	private Position pos;
	
	public ServerSnakeNode(Position position, Color color){
	...
	public ServerSnakeNode(int x, int y, Color color){
	...
	public ServerSnakeNode(ServerSnakeNode node){
		super(SIZE, SIZE);
