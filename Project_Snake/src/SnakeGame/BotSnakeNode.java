...
public class BotSnakeNode extends Rectangle{
	
	private static final double SIZE = Game.ELEMENT_SIZE; 

	private Position pos;
	
	public BotSnakeNode(Position position, Color color){
	...
	public BotSnakeNode(int x, int y , Color color ){
	...
	public BotSnakeNode(BotSnakeNode node){
		super(SIZE, SIZE);
...
/*	public BotSnakeNode(Position position){
...
/*	public BotSnakeNode(int x, int y){
